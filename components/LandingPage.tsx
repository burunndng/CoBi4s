...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="space-y-32 py-20 animate-fade-in pb-32 relative">
      ...
      {/* Hero Section */}
      <section className="text-center space-y-12 max-w-4xl mx-auto px-4 relative z-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        {features.map((f, i) => (
          <button 
            ...
            className="surface p-10 rounded-3xl group border-white/[0.03] hover:border-white/10 transition-all duration-500 flex flex-col justify-between min-h-[320px] active:scale-[0.98] text-left relative z-10"
          >
            <div>
